            ...
            <div class="add-form col-xl-4 border rounded py-3">
                ...
                <form>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="employee-firstname"
                               placeholder="Enter firstname">
                    </div>
                    <div class="form-group">
                        <label for="employee-lastname">Lastname</label>
                        <input type="text" class="form-control" id="employee-lastname"
                    ...
                    <div class="form-group">
                        ...
                        <select class="browser-default custom-select" id="employee-positions">
